...
object CombinedClientApp extends App {
  ...
  def parse(inputString: String): (List[Int], List[Int]) = {
    ...
    // Parsing each list string into a List[Int]
  ...
  Thread.sleep(2000)
  private var list = (List.empty[Int], List.empty[Int])
  private var PoliceMan_Hint = -1
  private var Thief_Hint = -1
